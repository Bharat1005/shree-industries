    ...
    <div className="w-full bg-white relative overflow-hidden border-t border-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-12 sm:pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 border-b border-slate-100 pb-12">
            ...
            <div className="flex flex-wrap gap-2.5 pt-1">
              {[
                ...
                <a 
                  ...
                  href={item.href}
                  title={item.name}
                  className="w-8 h-8 rounded-full bg-slate-50 text-brand-blue flex items-center justify-center hover:bg-brand-blue hover:text-white transition-all duration-300 shadow-sm border border-slate-100"
                >
                  {item.icon}
                </a>
              ))}
          ...
          {/* Column 3: Contact Details (5 cols) */}
            ...
            <div className="space-y-4 text-slate-600 text-sm font-medium">
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-2.5">
                  <div className="w-5 h-5 rounded-full bg-slate-50 flex items-center justify-center text-brand-blue flex-shrink-0 mt-0.5">
                    <MapPin size={14} />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-2.5 pl-7">
                  <div className="w-5 h-5 rounded-full bg-slate-50 flex items-center justify-center text-brand-blue flex-shrink-0">
                    <Phone size={13} />
                  </div>
                  <div className="flex flex-wrap gap-x-2 text-xs sm:text-sm">
                    <a href="tel:+919913746700" className="hover:text-brand-blue transition-colors">+91 99137 46700</a>
                    <span className="text-slate-300">|</span>
                    <a href="tel:+919724346700" className="hover:text-brand-blue transition-colors">+91 97243 46700</a>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2 border-t border-slate-100 pt-3">
                ...
                <div className="flex items-center gap-2.5 pl-7">
                  ...
                  <a href="tel:+919426943385" className="hover:text-brand-blue transition-colors text-xs sm:text-sm">
                    +91 94269 43385
                  </a>
                </div>
              </div>
